...
public class PracticeGaaf extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void onDetectClicked() {
        ...
        if(indexSecond==10&& indexFirst==10)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");

        }
        else if(indexSecond==10)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");
        }
        else if(indexFirst==10) {
