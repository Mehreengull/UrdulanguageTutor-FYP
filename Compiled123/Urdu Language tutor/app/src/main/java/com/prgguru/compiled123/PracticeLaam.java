...
public class PracticeLaam extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void onDetectClicked() {
        ...
        if(indexSecond==19&& indexFirst==19)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");

        }
        else if(indexSecond==19)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");
        }
        else if(indexFirst==19) {
