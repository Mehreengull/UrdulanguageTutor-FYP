...
public class ActivityAlifPractice extends AppCompatActivity implements View.OnTouchListener {


    private static final String    TAG         = "ActivityAlifPractice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alif_practice);
    ...
    private void onDetectClicked() {
        ...
        Toast.makeText(getApplicationContext(),"Index: "+ indexMnist +","+indexConvnet ,Toast.LENGTH_LONG).show();
        mResultTextMnist.setText("accuracy : " + "96 %");//labels[indexMnist]);
