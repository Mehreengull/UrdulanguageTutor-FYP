...
public class PracticeHaa extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void onDetectClicked() {
        ...
        if(indexSecond==14&& indexFirst==14)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");

        }
        else if(indexSecond==14)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");
        }
        else if(indexFirst==14) {
