...
public class PracticeHaay extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void onDetectClicked() {
        ...
        if(indexSecond==12&& indexFirst==12)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");

        }
        else if(indexSecond==12)
        {
            mResultTextFirst.setText("Label:"+ s+"Accuracy:"+modelOutputSecond[indexSecond]+"%");
        }
        else if(indexFirst==12) {
