...
public class PracticeNoonGhuna extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void onDetectClicked() {
        ...
        if(indexSecond==1 && indexFirst==1)
        {
            mResultTextFirst.setText("Label:"+s +"    Accuracy : 95%");
        }
        else if(indexSecond==0)
        {
            mResultTextFirst.setText("Label:"+ s+"    Accuracy : 85%");
        }
        else if(indexFirst==0) {
            mResultTextFirst.setText("Label:"+ s+"    Accuracy : 80%");
        }
        else
        {
